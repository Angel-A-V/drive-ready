...
- [x] Set up the basic scene, camera, and renderer — concepts: three-js-scene-camera-renderer
- [x] Add a 3D object to the scene (geometry + material) — concepts: 3d-geometry-materials
