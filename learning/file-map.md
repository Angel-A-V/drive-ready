...
- src/main.js — known (2026-08-08) — JS entry point loaded by index.html; imports Three.js (`import * as THREE from 'three'`) and is where the 3D scene code will live → [[three-js]]
